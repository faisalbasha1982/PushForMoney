...
function fetchJson(url,payload) {
  ...
  function fetchProfile(payload) {
    ...
    return fetchJson(API_URL.staging.laMobileGetUserData);
  }
...
function fetchUpdateFirstName(payload){
    ...
    return fetchJson(API_URL.staging.laMobileUserUpdateFirstAndLastName);
...
function fetchOTPMobile(payload) {
    ...
    return fetchJson(API_URL.staging.laMobileOtpVerification);    
