...
import newStyle from './Styles/PushToAddFriendComponentStyles';
...
class PushToEarnAddFriendComponent extends Component {
...
const mapStateToProps = state => {
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(PushToEarnAddFriendComponent);