...
const Api_url = {
  ...
  production: {
    laMobileGetUserData:'',
    laMobileGetUserReferralsWithStatus:'',
    laMobileOtpVerification:'',
    laMobilePushForJob:'',
    laMobileReferralEmailSummary:'',
    laMobileReferralsAdd:'',
    laMobileReferralsFinishedStatusUpdate:'',
    laMobileReferralsUpdateWaitingStatus:'',
    laMobileSaveNewPassword:'',
    laMobileSendForgotPasswordOTP:'',
    laMobileStoreUserBankDetails:'',
    laMobileUserResendSignupOTP:'',
    laMobileUserSignUp:'',
    laMobileUserUpdateFirstAndLastName:'',
